...
var _Chat = __webpack_require__(35);

var _Chat2 = _interopRequireDefault(_Chat);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_reactDom2.default.render(_react2.default.createElement(_Chat2.default, null), document.getElementById('yac'));
...
var _ChatBox = __webpack_require__(36);
...
var Chat = function (_React$Component) {
    ...
    _createClass(Chat, [{
        ...
        value: function handleLogin(event) {
            ...
            _axios2.default.get('/user-exists/' + this.username).then(function (response) {
                return response.data;
            }).then(function (data) {
                if (data.length > 0) {
                    alert("Username " + _this2.username + " has been taken, choose another one");
                } else {
                    localStorage.setItem('yac_username', _this2.username);
                    _this2.setState({ user: _this2.username });
                    _Util.socket.emit('joined', _this2.username);
                }
        ...
        value: function render() {
            if (this.state.user == null) {
                this.form = _react2.default.createElement(
                    'form',
                    { className: 'col-md-3', onSubmit: this.handleLogin },
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            { htmlFor: 'username' },
                            'Username:',
                            _react2.default.createElement('input', { className: 'form-control', type: 'text', onChange: this.handleUsername, id: 'username', name: 'username' })
                        )
                    ),
                    _react2.default.createElement('input', { className: 'btn btn-primary mb-2', type: 'submit', value: 'Log in' })
                );
            } else {
                this.form = _react2.default.createElement(_ChatBox2.default, { user: this.username });
            }
...
var _ChatMessage = __webpack_require__(37);
...
var ChatBox = function (_React$Component) {
    ...
    function ChatBox(props) {
        ...
        _this.handleNewGif = _this.handleNewGif.bind(_this);
        _this.handleGif = _this.handleGif.bind(_this);
    ...
    _createClass(ChatBox, [{
        ...
        value: function componentDidMount() {
            ...
            _axios2.default.get('/history').then(function (response) {
                return response.data;
            }).then(function (data) {
                var history = _this2.state.messages;
                var _iteratorNormalCompletion = true;
                var _didIteratorError = false;
                var _iteratorError = undefined;
                ...
                try {
                    for (var _iterator = data[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                        ...
                        _this2.setState({ messages: history });
                        _this2.updateScroll();
                    }
                } catch (err) {
                    _didIteratorError = true;
                ...
                _Util.socket.on('response', function (data) {
                    var history = _this2.state.messages;
        ...
        key: 'handleGif',
        value: function handleGif(event) {
            this.gif = event.target.value;
        }
    }, {
        key: 'handleNewMessage',
        value: function handleNewMessage(event) {
            _Util.socket.emit('message', this.message, this.props.user);
            document.getElementById('message').value = '';
            event.preventDefault();
        }
    }, {
        key: 'handleNewGif',
        value: function handleNewGif(event) {
            var _this3 = this;
            ...
            _axios2.default.get('http://api.giphy.com/v1/gifs/search', {
                ...
                _Util.socket.emit('message', '<iframe src="' + gif.embed_url + '" width="200" height="200" frameBorder="0" class="giphy-embed" allowFullScreen></iframe>', _this3.props.user);
            }).catch(function (error) {
                console.log(error);
            });
            event.preventDefault();
        ...
        value: function handleExit() {
            ...
            _Util.socket.emit('exit', this.props.user);
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { id: 'chat-container', className: 'col-md-10 mt-3 mb-3 border pt-3 border-primary rounded' },
                        _react2.default.createElement(
                            'ul',
                            { className: 'list-unstyled' },
                            this.state.messages.map(function (data, key) {
                                return _react2.default.createElement(_ChatMessage2.default, { username: data.username, message: data.message, key: key });
                            })
                        )
                    )
                ),
                _react2.default.createElement(
                    ...
                    this.state.active && _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'form',
                            { className: 'row align-items-center', onSubmit: this.handleNewMessage },
                            _react2.default.createElement(
                                'div',
                                { className: 'col-md-10' },
                                _react2.default.createElement('textarea', { placeholder: 'Type something...', className: 'form-control', onChange: this.handleMessage, id: 'message', name: 'message' })
                            ),
                            _react2.default.createElement(
                                'div',
                                { className: 'col-md-2' },
                                _react2.default.createElement('input', { className: 'btn btn-primary btn-block pt-4 pb-4', type: 'submit', value: 'Send' })
                            )
                        ),
                        _react2.default.createElement(
                            'form',
                            { className: 'row align-items-center mt-2', onSubmit: this.handleNewGif },
                            _react2.default.createElement(
                                'div',
                                { className: 'col-md-8' },
                                _react2.default.createElement('input', { type: 'text', placeholder: 'Send an awesome gif!', className: 'form-control', onChange: this.handleGif, id: 'gif', name: 'gif' })
                            ),
                            _react2.default.createElement(
                                'div',
                                { className: 'col-md-2' },
                                _react2.default.createElement('input', { className: 'btn btn-primary btn-block', type: 'submit', value: 'Gif' })
                            )
                        ),
                        _react2.default.createElement(
                            'div',
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'button',
                                    { className: 'btn btn-secondary btn-block', onClick: this.handleExit },
                                    'Exit'
                                )
                            )
                        )
            ...
            if (this.username == undefined) {
                this.setState({
                    message: _react2.default.createElement(
                        'li',
                        { className: 'text-center font-italic bg-info text-white pt-2 pb-2' },
                        this.message
                    )
                });
            } else {
                this.setState({
                    message: _react2.default.createElement(
                        'li',
                        { className: 'bg-light text-dark mt-2 mb-2 px-2' },
                        _react2.default.createElement(
                            'strong',
                            null,
                            this.username
                        ...
                        _react2.default.createElement('div', { dangerouslySetInnerHTML: this.createMarkup(this.message) })
                    )
                });
            }
        }
